...
nsys profile -w true -t cuda,nvtx,osrt,cudnn,cublas -s cpu  --capture-range=cudaProfilerApi  --cudabacktrace=true -x true \
        -o ./nsys_log/imdb_adan_single_fused_lr1e-4_wd1e-2_wm50_ep3_unmix_huggingface_nvtx \
        ...
        --lr 1e-4 --wd 0.01 \
        --optimizer adan \
        --log_file_name imdb_adan_fused_lr1e-4_wd1e-2_wm50_ep3_unmix_huggingface_nsys \
