...
accelerate launch --config_file ./accelerate_config/imdb_bert_base_acc_mix_DDP_2gpu.yaml \
        ...
        --lr 1e-4 --wd 0.01 \
        --optimizer adan \
        --log_file_name imdb_adan_fused_lr1e-4_wd1e-2_wm50_ep3_mixed_ddp_2GPU_lightseq_energy \
...
#         --lr 1e-4 --wd 0.01 \
#         --optimizer adan \
#         --log_file_name imdb_adan_fused_lr1e-4_wd1e-2_wm50_ep3_mixed_ddp_4GPU_lightseq \
#         --fused_optimizer True \
#         --batch_size 16 \
#         --seed 38 \
#         --module_type 1 \
