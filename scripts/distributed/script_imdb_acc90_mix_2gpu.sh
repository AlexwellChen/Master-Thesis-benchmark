...
accelerate launch --config_file ./accelerate_config/imdb_bert_base_acc_mix_2gpu.yaml \
         ./benchmark/imdb_bert_base_accelerate.py \
        --n_epochs 2 --warmup 50 \
        --lr 1e-4 --wd 0.01 \
        --optimizer adan \
        --log_file_name imdb_adan_fused_lr1e-4_wd1e-2_wm50_ep2_acc90_mix_2gpu \
        --target_val_acc 0.90 \
        --fused_optimizer True
echo "-----------------------2 GPU mix percision done------------------------"
# Plot the results
