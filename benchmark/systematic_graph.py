...
plt.savefig('overall_results_v3.png')
...
plt.savefig('Software_Optimization_v3.png')
...
plt.savefig('Best_Time_Cost_v3.png')
...
plt.savefig('Optimizer_Accuracy_Time_v3.png')
...
# subplot title
ax[0, 0].set_title('(A) Test Accuracy on Different Devices')
...
ax[1, 0].set_title('(C) Test Accuracy on Different Modules')
...
ax[1, 1].set_title('(D) Test Accuracy on Different Data types')
sns.boxplot(data=df, y='accuracy', x='mixed_precision', ax=ax[1, 1])

plt.savefig('Accuracy_with_para_v3.png')
