...
#Had to manually download the hugginface folder from their GitHub
#and had to make changes in the init file in the site-package folder to include this file..
from lightseq.training.huggingface.bert.ls_hf_transformer_layer import LSBertForSequenceClassification
